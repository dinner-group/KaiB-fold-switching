...
if args.dinner==True:
    partition='weare-dinner2'              # use dinner if arg passed 
    time_limit=172000.0
    run_time='48:00:00'
    mem='375G'
    qos='weare-dinner'
...
upside_path = '/project2/dinner/darrenjl/upside2-md' #os.environ['UPSIDE_HOME']
...
account          = 'weare-dinner'#"pi-dinner"
...
sbatch_opts = sbatch_opts.format(account, job_name, log_file, run_time, partition, args.n_rep, mem, qos) 
