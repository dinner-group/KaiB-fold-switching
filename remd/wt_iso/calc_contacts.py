...
def main():
    ...
    gs_switch_selection = gs_traj.top.select("protein and resid 51 to 105")
    fs_selection = fs_traj.top.select("protein")
    fs_switch_selection = fs_traj.top.select("protein and resid 51 to 105")
    ...
    for i, dfile in enumerate(dfiles):
        ...
        traj = mu.load_upside_traj(dfile)
